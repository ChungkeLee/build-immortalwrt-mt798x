...
#修改wifi名称（mtwifi-cfg）
sed -i 's/ImmortalWrt-2.4G/2.4G/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
sed -i 's/ImmortalWrt-5G/5G/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
